...
app.get('./listar_clientes', async (req, res) => {
    try {
        ...
        // Definindo a consulta SQL para buscar os clientes
        const query = 'SELECT * FROM TABLETK2'; // Substitua 'tabela_de_clientes' pelo nome da sua tabela
        
        // Executando a consulta SQL
        const result = await sql.query(query);
        
        // Enviando os resultados de volta ao cliente
